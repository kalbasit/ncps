...
{{- if gt (int .Values.replicaCount) 1 -}}
  ...
  {{- if and (gt (int .Values.replicaCount) 1) (not .Values.config.cdc.enabled) (not .Values.config.cdc.iLoveTimeouts) -}}
    {{- fail "High availability mode (replicaCount > 1) requires CDC to be enabled (config.cdc.enabled=true) to prevent timeouts and instability. See https://github.com/kalbasit/ncps/issues/660. Set config.cdc.iLoveTimeouts to true if you want to ignore this warning." -}}
  {{- end -}}
{{- end -}}
