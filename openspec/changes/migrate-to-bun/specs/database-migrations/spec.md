...
### Requirement: Migration files are embedded in the binary
...
### Requirement: Migration files follow bun/migrate naming convention
...
### Requirement: `ncps migrate` CLI command
...
### Requirement: Migration state is tracked in the database
...
### Requirement: New migration files are plain SQL pairs
