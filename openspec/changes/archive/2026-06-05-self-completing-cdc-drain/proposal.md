...
A complementary fsck safety net (a daily-janitor, grace-period mark-then-purge reclaimer for chunked-NAR residue) is split into its own change, since it needs a persistent mark column and two-phase logic.
