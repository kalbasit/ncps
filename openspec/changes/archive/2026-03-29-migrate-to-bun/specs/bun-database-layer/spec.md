...
### Requirement: `*bun.DB` is the sole database handle
...
### Requirement: OTel instrumentation is preserved
...
### Requirement: Bun model structs have complete struct tags
...
### Requirement: Transactions use `bun.IDB`
...
### Requirement: Engine-specific SQL via Bun query builder or raw queries
...
### Requirement: Engine sub-packages are removed
