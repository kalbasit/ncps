# Spec: dynamic-test-ports

## Purpose

Define how the `test-deps` process-compose profile and its associated helper
scripts support caller-supplied port numbers, enabling multiple isolated test
environments to run concurrently without port conflicts.
