...
type Querier interface {
	...
	GetCDCNarFilesWithSizeMismatch(ctx context.Context) ([]NarFile, error)
	//GetChunkByHash
	//
	//  SELECT id, hash, size, compressed_size, created_at, updated_at
	//  FROM chunks
	...
	// GetPinnedClosureByID (Synthetic)
	GetPinnedClosureByID(ctx context.Context, id int64) (PinnedClosure, error)
