...
func (w *postgresWrapper) GetCDCNarFilesWithSizeMismatch(ctx context.Context) ([]NarFile, error) {
	/* --- Auto-Loop for Bulk Insert on Non-Postgres --- */
...
func (w *postgresWrapper) GetChunksByNarFileIDFromIndex(ctx context.Context, arg GetChunksByNarFileIDFromIndexParams) ([]GetChunksByNarFileIDFromIndexRow, error) {
	/* --- Auto-Loop for Bulk Insert on Non-Postgres --- */

	res, err := w.adapter.GetChunksByNarFileIDFromIndex(ctx, postgresdb.GetChunksByNarFileIDFromIndexParams{
		NarFileID:  arg.NarFileID,
		ChunkIndex: arg.ChunkIndex,
		Limit:      arg.Limit,
	})
...
func (w *postgresWrapper) GetOldCompressedNarFiles(ctx context.Context, cutoffTime time.Time) ([]GetOldCompressedNarFilesRow, error) {
	/* --- Auto-Loop for Bulk Insert on Non-Postgres --- */
