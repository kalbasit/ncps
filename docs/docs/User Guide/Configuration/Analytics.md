...
See <a class="reference-link" href="Observability.md">Observability</a> for details on OpenTelemetry.
...
Not currently. The analytics endpoint is hardcoded to `otlp.ncps.dev:443`. If you need to send telemetry to your own infrastructure, use OpenTelemetry instead (see <a class="reference-link" href="Observability.md">Observability</a>).
