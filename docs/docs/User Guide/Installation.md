...
1. <a class="reference-link" href="Usage/Client%20Setup.md">Client Setup</a>

   - Add ncps as a substituter
   - Add public key to trusted keys

1. <a class="reference-link" href="Operations/Monitoring.md">Monitoring</a> (Optional but recommended)
...
1. [Set up Nix clients](Usage/Client%20Setup.md)
1. [Monitor your cache](Operations/Monitoring.md)
