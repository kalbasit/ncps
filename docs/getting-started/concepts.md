[Home](../../README.md) > [Documentation](../README.md) > [Getting Started](README.md) > Core Concepts
...
See the [High Availability Guide](../deployment/high-availability.md) for detailed setup instructions.
...
- [Quick Start Guide](quick-start.md) - Get ncps running quickly
- [Architecture Details](../architecture/) - Deep dive into internals
