[Home](../../README.md) > [Documentation](../README.md) > [Getting Started](README.md) > Quick Start
...
- [Docker Installation Guide](../installation/docker.md) - Detailed Docker setup
- [Docker Compose Guide](../installation/docker-compose.md) - Automated setup
