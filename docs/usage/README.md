...
1. [Configure NixOS clients](client-setup.md#nixos-configuration)
1. [Configure non-NixOS clients](client-setup.md#non-nixos-configuration)
1. [Verify it works](client-setup.md#verify)

### Managing Your Cache

1. [Configure cache size limits](cache-management.md#size-limits)
1. [Set up LRU cleanup](cache-management.md#lru-cleanup)
1. [Monitor cache usage](cache-management.md#monitoring)
