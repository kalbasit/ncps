[Home](../../README.md) > [Documentation](../README.md) > [Installation](README.md) > Docker Compose
...
See [Monitoring Guide](../operations/monitoring.md) for Grafana dashboard setup.
...
- [Docker Installation](docker.md) - Manual Docker setup
