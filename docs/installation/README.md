...
1. **[Configure Clients](../usage/client-setup.md)**

   - Add ncps as a substituter
   - Add public key to trusted keys

1. **[Configure Monitoring](../operations/monitoring.md)** (Optional but recommended)
...
1. [Set up Nix clients](../usage/client-setup.md)
