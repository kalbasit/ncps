[Home](../../README.md) > [Documentation](../README.md) > [Installation](README.md) > NixOS
...
- [NixOS Options Search](https://search.nixos.org/options?query=services.ncps) - All module options
- [Docker Installation](docker.md) - For S3 storage on NixOS
- [Configuration Reference](../configuration/reference.md) - All configuration options
- [Usage Guide](../usage/client-setup.md) - Configure Nix clients
