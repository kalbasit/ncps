...
cmd_generate() {
  ...
  generate_existing_secret_scripts "$cluster_json"
...
generate_existing_secret_scripts() {
  ...
  # (Placeholder - would generate setup scripts for external secrets)
  # For now, just note that they're needed
  echo "✅ Generated existing-secret setup scripts (placeholder)"
}
